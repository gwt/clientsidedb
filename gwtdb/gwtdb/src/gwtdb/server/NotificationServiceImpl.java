...
public class NotificationServiceImpl extends DatastoreLayer implements NotificationService {
	...
	public static void notifyClients(final String messageToClient) {
